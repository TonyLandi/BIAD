...
namespace LabBot.Dialogs
{
    ...
    public class RootDialog : IDialog<object>
    {
        ...
        {
            // Ask the user if they would like to take a survey after completing
        ...
        private async Task AfterAskingAboutSurvey(IDialogContext context, IAwaitable<bool> result)
        {
            ...
            {
                // If the user said yes to taking the survey, call the dialog to have them fill out the form
